...
public class RetryAnalyzer implements IRetryAnalyzer {
    ...
    public boolean retry(ITestResult result) {
     ...
     /**
     * Read-only predicate for listeners to query retry intent without
     * mutating state. TestNG's own retry() call handles actual state changes.
     */
    public boolean willRetry(ITestResult result) {
        ...
        return isRetryable(throwable) || currentRetryCount == 0;
    }
    ...
    private void logDecision(String testMethod, String exceptionType, int attemptCount, String reason) {
        ...
        logger.info("[{}] {} - {} ({}, retry {}/{})",
                testMethod, reason, exceptionType, status, attemptCount, MAX_RETRY_COUNT);
    }
