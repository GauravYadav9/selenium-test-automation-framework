 ...
 * Encapsulates form fields and actions for entering passenger
 * and payment information to complete the booking.
 */
public class PurchasePage extends BasePage {
    ...
    public void fillPurchaseForm(Passenger passenger) {
        logger.info("Filling purchase form for passenger: {} {}",passenger.firstName(), passenger.lastName());
        enterFirstName(passenger.firstName() + " " + passenger.lastName());
