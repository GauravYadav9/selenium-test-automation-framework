...
public class AiDataGenerator {
     ...
     * Accepts a PassengerDataService directly, bypassing AiServices proxy.
     */
    AiDataGenerator(PassengerDataService service) {
        this.service = service;
        logger.info("AiDataGenerator initialized with direct service");
    }
